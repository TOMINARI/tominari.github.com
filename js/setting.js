...
OpenSpending.Styles.Cofog = {
  ...
  '2-3': { icon: 'icons/research.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-4': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-5': { icon: 'icons/ekonomija.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-6': { icon: 'icons/payroll.svg', color: '#C75746', bcolor: '#0AB971' },
  ...
  '3-3': { icon: 'icons/sangyou3.svg', color: '#C75746', bcolor: '#4E6D00' },
  '4': { icon: 'icons/c_kosodate_shien.svg', color: '#C75746', bcolor: '#D33673' },
  '4-1': { icon: 'icons/child.svg', color: '#C75746', bcolor: '#D33673' },
  '4-2': { icon: 'icons/c_kosodate_shien.svg', color: '#C75746', bcolor: '#D33673' },
  '4-3': { icon: 'icons/schools.svg', color: '#C75746', bcolor: '#D33673' },
  ...
  '6-2': { icon: 'icons/c_nougyou.svg', color: '#C75746', bcolor: '#EC2406' },
  '6-3': { icon: 'icons/forest.svg', color: '#C75746', bcolor: '#EC2406' },
  '6-4': { icon: 'icons/harbor.svg', color: '#C75746', bcolor: '#EC2406' },
  '6-5': { icon: 'icons/debt-asahikawa.svg', color: '#C75746', bcolor: '#EC2406' },
  '7': { icon: 'icons/machi.svg', color: '#C75746', bcolor: '#938626' },
  '7-1': { icon: 'icons/construction.svg', color: '#C75746', bcolor: '#938626' },
  '7-2': { icon: 'icons/car.svg', color: '#C75746', bcolor: '#938626' },
  '7-3': { icon: 'icons/c_waterdoun.svg', color: '#C75746', bcolor: '#938626' },
  '7-4': { icon: 'icons/traffic-watersup.svg', color: '#C75746', bcolor: '#938626' },
  '7-5': { icon: 'icons/housing.svg', color: '#C75746', bcolor: '#938626' },
  '8': { icon: 'icons/c_syoubou_bousai.svg', color: '#C75746', bcolor: '#C75746' },
  '8-1': { icon: 'icons/c_syoubou_bousai.svg', color: '#C75746', bcolor: '#C75746' },
  '8-2': { icon: 'icons/c_bousai.svg', color: '#C75746', bcolor: '#C75746' },
  '8-3': { icon: 'icons/snow-removal.svg', color: '#C75746', bcolor: '#C75746' },
  '9': { icon: 'icons/sports.svg', color: '#C75746', bcolor: '#D33673' },
  '9-1': { icon: 'icons/pre-school.svg', color: '#C75746', bcolor: '#D33673' },
  '9-2': { icon: 'icons/pio_mio.svg', color: '#C75746', bcolor: '#D33673' },
  '9-3': { icon: 'icons/c_kenkou.svg', color: '#C75746', bcolor: '#D33673' },
  '10': { icon: 'icons/public-debt.svg', color: '#C75746', bcolor: '#790586' },
  '10-1': { icon: 'icons/public-debt.svg', color: '#C75746', bcolor: '#790586' },
